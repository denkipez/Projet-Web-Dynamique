...
<div class="containerMedecin">
    ...
    if ($db_found){
        ...
        while($data = mysqli_fetch_assoc($resultat)){
            ...
            $contenu.='<div class="text"><ul style="list-style-type:none"><li><p class=text-container1><strong>'.$data['Nom'] .' ' .  $data['Prenom'] .'</strong><br></p></li>';
            $contenu.='<li><p class="text2-container2">Médecin généraliste</p></li><li><a class="btn btn-custom">En savoir plus</a></li></ul></div></div>';
