          ...
          if (Test==true) { // valid?
           ...
           $DateFin='<script type="text/javascript">document.write(Fin);</script>';
            ...
            if ($db_found && isset($_COOKIE['DEBUT']) && isset($_COOKIE['FIN']) ){
                ...
                $sql="INSERT INTO `rendezvous`(`Date`,`HeureDebut`,`HeureFin`,`IDPATIENT`,`IDPERSONNEL`,`CarteVitale`) VALUES ('".$Debut[0]."','".$Debut[1]."','".$Fin[1]."','".$_SESSION['Id']."','11','".$_SESSION['CarteVitale']."')";
